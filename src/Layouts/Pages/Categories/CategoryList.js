            ...
            <Modal show={showViewModal} onHide={handleCloseView}>
                ...
                <Modal.Body>
                    ...
                    <div className="mb-3">
                        ...
                        <ul className="mt-2">
                            <li>Discount Rate: <strong>{selectedCategory.discountPercentage}%</strong></li>
                            <li>Commission Rate: <strong>{selectedCategory.commissionPercentage}%</strong></li>
                        </ul>
                    </div>
                    ...
                    <div className="mb-3">
                        ...
                        <ul className="mt-2">
                            <li>Active Profiles: <strong>{selectedCategory.activeProfiles}</strong></li>
                            <li>Created: <strong>{selectedCategory.createdAt}</strong></li>
                        </ul>
                    </div>
